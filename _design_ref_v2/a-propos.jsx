/* global React, ReactDOM, Header, Footer, PageHero, PageShell, PillButton, Eyebrow, Counter, ArrowIcon */

const OBJECTIFS = [
  {
    n: "01",
    title: "Promouvoir le statut de la femme rurale",
    body: "Renforcer le statut socio-économique des femmes rurales du département de l'Atacora à travers la formation, l'alphabétisation et l'accès aux moyens de production.",
  },
  {
    n: "02",
    title: "Scolariser orphelins et enfants vulnérables",
    body: "Garantir un accès à l'éducation de qualité aux enfants vulnérables, prendre en charge frais de scolarité, fournitures et soutien psycho-social.",
  },
  {
    n: "03",
    title: "Inclusion financière des femmes",
    body: "Faciliter l'accès des filles et femmes rurales aux services financiers — épargne, micro-crédit, formation entrepreneuriale, AGR.",
  },
  {
    n: "04",
    title: "Lutter contre les VBG",
    body: "Prévenir et combattre les violences basées sur le genre par la sensibilisation communautaire, l'accompagnement des victimes et le plaidoyer.",
  },
  {
    n: "05",
    title: "Résilience climatique",
    body: "Renforcer la capacité des communautés rurales à anticiper et s'adapter aux effets du changement climatique : agriculture durable, gestion de l'eau, reboisement.",
  },
  {
    n: "06",
    title: "Œuvres sociales communautaires",
    body: "Mener des actions de solidarité auprès des populations vulnérables : aides ponctuelles, distributions, accompagnement des familles en difficulté.",
  },
];
...
function MissionVision() {
  return (
    <section className="py-24">
      <div className="max-w-[1320px] mx-auto px-6 grid grid-cols-12 gap-7">
...
function LogoMeaning() {
  return (
    <section className="py-24 bg-cream">
      <div className="max-w-[1320px] mx-auto px-6 grid grid-cols-12 gap-12 items-center">
        <div className="col-span-12 lg:col-span-5">
          <div className="aspect-square rounded-[36px] bg-paper grid place-items-center p-12 ring-1 ring-ink/5">
            <img src="assets/photo-1.jpeg" alt="Logo Elite Atacora" className="max-w-[80%] max-h-[80%] object-contain" />
          </div>
        </div>
        <div className="col-span-12 lg:col-span-7">
          <Eyebrow color="forest">Signification du logo · Article 9</Eyebrow>
          <h2 className="mt-5 font-serif text-[40px] sm:text-[48px] leading-[1.05] text-ink tracking-tight">
            Une femme qui gravit, l'<em className="italic text-terracotta">Atacora</em> qui s'élève.
          </h2>
          <p className="mt-6 text-coffee text-[16px] leading-[1.75] max-w-xl">
            Notre logo représente une femme en marche, gravissant des escaliers
            sur lesquels est inscrit le mot <strong>SUCCESS</strong>, le tout
            superposé à la carte du Bénin. Cette image incarne nos trois
            engagements : l'élévation des femmes, l'ancrage territorial, et la
            promesse d'un avenir meilleur — marche après marche.
          </p>
          <div className="mt-8 grid grid-cols-3 gap-4 max-w-lg">
            <div>
              <div className="text-[10px] uppercase tracking-widest text-muted">Élément 1</div>
              <div className="mt-1 font-serif text-[18px] text-ink">La femme</div>
            </div>
            <div>
              <div className="text-[10px] uppercase tracking-widest text-muted">Élément 2</div>
              <div className="mt-1 font-serif text-[18px] text-ink">L'escalier</div>
            </div>
            <div>
              <div className="text-[10px] uppercase tracking-widest text-muted">Élément 3</div>
              <div className="mt-1 font-serif text-[18px] text-ink">La carte</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        <div className="bg-ink text-cream rounded-[40px] p-10 sm:p-16 grid grid-cols-12 gap-10 items-center relative overflow-hidden">
          <div className="col-span-12 lg:col-span-8">
            ...
            <h3 className="mt-5 font-serif text-[36px] sm:text-[48px] leading-[1.05] tracking-tight">
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-wrap gap-3 lg:justify-end">
            <PillButton as="a" href="adherer.html" variant="onDark">Adhérer</PillButton>
            <PillButton as="a" href="gouvernance.html" variant="primary">Voir l'équipe</PillButton>
          </div>
        </div>
      </div>
    </section>
...
function App() {
  return (
    <PageShell active="a-propos" label="À propos">
      <PageHero
