...
const NEWS = [
  {
    ...
    image: window.__resources.photo5, minutes: 4,
  },
  {
    ...
    image: window.__resources.photo7, minutes: 3,
  },
  {
    ...
    image: window.__resources.photo2, minutes: 2,
  },
];
...
const EVENTS = [
  {
    ...
    time: "09h00 → 13h00",
    type: "Statutaire",
    image: window.__resources.photo5,
    featured: true,
  },
  {
    ...
    time: "08h30 → 17h00",
    type: "Atelier",
    image: window.__resources.photo7,
  },
  {
    ...
    image: window.__resources.photo3,
  },
];
          ...
          <div className="relative pt-4 lg:pt-12">
            <div className="relative">
              <div className="aspect-[3/4] arch-top rounded-b-3xl overflow-hidden ring-frame">
                <img src={window.__resources.photo5} alt="Membres de l'ONG en réunion" className="w-full h-full object-cover" />
            ...
            <div className="absolute -bottom-12 -right-2 lg:-right-8 w-32 h-32 rounded-full overflow-hidden ring-4 ring-cream shadow-[0_20px_30px_-15px_rgba(30,24,19,0.4)]">
              <img src={window.__resources.photo2} alt="Kit maraîcher" className="w-full h-full object-cover" />
            </div>
